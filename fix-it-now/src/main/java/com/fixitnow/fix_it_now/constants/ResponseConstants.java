package com.fixitnow.fix_it_now.constants;
...
public class ResponseConstants {
    ...
    public static final String USER_DELETE_SUCCESS = "User deleted successfully with ID: ";
    public static final String ISSUE_TITLE_NULL_WR = "Issue title can not be null";
    public static final String ISSUE_ID_NOT_FOUND = "Issue with ID: {} not found";
    public static final String ISSUE_DELETE_SUCCESS = "Issue deleted successfully with ID: ";
}
